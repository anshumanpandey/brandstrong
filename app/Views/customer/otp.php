					...
					<div class="kt-grid__item kt-grid__item--fluid  kt-grid__item--order-tablet-and-mobile-1  kt-login__wrapper">
						...
						<div class="kt-login__body" style="padding: 155px 74px;">
							...
							<div class="kt-login__form">
								...
								<!--begin::Form-->
								<form class="kt-form" action="<?= base_url('checkotp') ?>" method="post">
									...
									<div class="form-group">
										<input class="form-control" type="number" placeholder="Enter OTP" name="otp" autocomplete="off" required="">
									</div>
									
									<button type="submit" class="btn btn-primary btn-elevate kt-login__btn-primary" style="width: 100%;">Verify OTP</button>
									<!--end::Action-->
								</form>
