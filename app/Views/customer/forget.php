					...
					<div class="kt-grid__item kt-grid__item--fluid  kt-grid__item--order-tablet-and-mobile-1  kt-login__wrapper">
						...
						<div class="kt-login__body" style="padding: 155px 74px;">
							...
							<div class="kt-login__form">
								...
								<!--begin::Form-->
								<form class="kt-form" action="<?= base_url('checkforget') ?>" method="post">
									...
									<button type="submit" class="btn btn-primary btn-elevate kt-login__btn-primary" style="width: 100%;">Forget Password</button>
									<!--end::Action-->
								</form>
