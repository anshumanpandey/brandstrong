									...
									<div class="kt-portlet">
                                        ...
                                        <div class="kt-portlet__head">
											...
											<div class="row" style="width:100%;">
                                               <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7"><table class="" width="100%">
										<tr>
...
<li>1 Active Marketing Requests</li>
...
<li>3 Active Marketing Requests</li>
...
<li>5 Active Marketing Requests</li>

<li>Marketing Review</li>

<li>Brand Style Guide</li>

<li>Monthly Website Analytics</li>

<li>Rush Job Access</li>
